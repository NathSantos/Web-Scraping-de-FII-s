...
Original file is located at
    https://colab.research.google.com/drive/1wYL_2rxTqQsFFb87DvdN-RseZhl-OoF-

---
# <font color=orange> Web Scraping de FIIs (Fundos Imobiliários)
...
"""## <font color='orange'> Identificando as informações no HTML

**Pegando os dados da tabela de DIVIDENDOS do TRXF11**
"""

tabela = soup.find('div', {"style":"min-height:479px"})
tabela

# Pegando os atributos e já colocando em uma lista
atributos = tabela.findAll('th')
atributos

# Pegando os respectivos valores e já colocando em uma lista
valores = tabela.findAll('td')
valores
...
for valor in valores:
    if(i==3):
        listaValoresInd.append(valor.getText())
        listaValores.append(listaValoresInd)
        listaValoresInd = []
        i=0
    else:
        listaValoresInd.append(valor.getText())
...
listaValores # Lista de listas com as linhas do dataframe

data = {}
value = []
for i in range(len(atributos)):
    for j in range(len(listaValores)):
        value.append(listaValores[j][i])
    
    data[atributos[i].getText()] = value
    value = []
